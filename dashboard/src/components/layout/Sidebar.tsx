...
const navigation = [
  ...
  { name: "Schedules", href: ROUTES.SCHEDULES, icon: CalendarClock },
  { name: "Voice Ops", href: ROUTES.VOICE_OPS, icon: PhoneCall },
  { name: "Telephony", href: ROUTES.TELEPHONY, icon: Activity },
