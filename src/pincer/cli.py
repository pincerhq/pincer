    ...
    try:
        ...
        tools.register(
            ...
            description=(
                ...
                "You MUST include this URL in your final response to the user so they can open the event. "
                "On failure, the tool returns an error message. Pass that exact message to the user; do not claim success."
            ),
